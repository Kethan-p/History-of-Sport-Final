...
function Section3_Challenges() {
  const barriers = [
    ...
    },
    {
      ...
      details: [
        "Negative misconceptions about physical strength and endurance",
        "Dismissive stereotypes around aggression and competitiveness",
        "Obstructive gender norms shaping who is encouraged to race"
      ]
    },
    {
        ...
        <div className="sources-list">
          <div className="source-item">
            <a href="https://www.sciencedirect.com/science/article/abs/pii/S1469029220308232?via%3Dihub" target="_blank" rel="noopener noreferrer">
              <strong>Kochanek et al. (2020): More than “just a driver”: A study of professional women racecar drivers' agency in motorsport</strong>
            </a>
          ...
          <div className="source-item">
            <a href="https://www.womeninsport.org/research-and-advice/our-publications/where-are-all-the-women" target="_blank" rel="noopener noreferrer">
              <strong>Women in Sport (2018): Where are all the Women? Shining a light on the visibility of women’s sport in the media</strong>
            </a>
            <p className="source-description">
          ...
          <div className="source-item">
            <a href="https://journals.lww.com/acsm-msse/Fulltext/2019/12000/Physiological_Responses_of_Male_and_Female_Race.18.aspx" target="_blank" rel="noopener noreferrer">
              <strong>Ferguson et al. (2019): Body Composition, and Neck Strength of Elite Motor Racing Drivers</strong>
            </a>
            <p className="source-description">
              Scientific study of the physiological responses of race car drivers during competition, providing evidence that challenges assumptions about physical differences and their impact on racing performance.
            </p>
          </div>
          <div className="source-item">
            <a href="https://www.sciencedirect.com/science/article/abs/pii/S1469029220308232?via%3Dihub" target="_blank" rel="noopener noreferrer">
          ...
          <div className="source-item">
            <a href="https://www.sciencedirect.com/science/article/abs/pii/S1469029217305083" target="_blank" rel="noopener noreferrer">
              <strong>Gentile et al. (2018): ‘You play like a Woman!’ Effects of gender stereotype threat on Women's performance in physical and sport activities: A meta-analysis</strong>
            </a>
            <p className="source-description">
          ...
          <div className="source-item">
            <a href="https://www.independent.co.uk/sport/motor-racing/bernie-ecclestone-centre-sexism-row-after-claiming-women-drivers-wouldnt-be-taken-seriously-a6816456.html" target="_blank" rel="noopener noreferrer">
              <strong>de Menezes (2016): Bernie Ecclestone at centre of sexism row after claiming women F1 drivers 'wouldn't be taken seriously</strong>
            </a>
            <p className="source-description">
          ...
          <div className="source-item">
            <a href="https://www.dailyrecord.co.uk/news/scottish-news/no-time-formula-1-champion-10061906" target="_blank" rel="noopener noreferrer">
              <strong>Houston (2017): No-time Formula 1 champion David Coulthard thinks women aren't built to win the race</strong>
            </a>
            <p className="source-description">
          ...
          <div className="source-item">
            <a href="https://journals.sagepub.com/doi/pdf/10.1177/0193723509350611" target="_blank" rel="noopener noreferrer">
              <strong>Pflugfelder (2009): Something Less than a Driver: Toward an Understanding of Gendered Bodies in Motorsport Gendered Bodies in Motorsport</strong>
            </a>
            <p className="source-description">
